...
<head>
    ...
    <title>Tambah Soal Ujian Akhir - CELEP</title>
        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Menambah Soal Ujian Akhir</h4>
                </div>
                <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    @foreach(['a','b','c','d'] as $opt)
                                        <div class="form-check form-check-inline mr-3">
                                            <input class="form-check-input" type="radio" name="jawaban_benar" id="jawaban_{{ $opt }}" value="{{ $opt }}" {{ old('jawaban_benar') == $opt ? 'checked' : '' }}>
